...
class DataManager:
    ...
    def _initialize_files(self):
        ...
        if not os.path.exists(self.passengers_file):
            pd.DataFrame(columns=[
                'phone', 'origin', 'destination', 'fare', 'journey_date'
    ...
    def add_passenger_journey(self, phone, origin, destination, fare, journey_date):
        """Add a new passenger journey"""
        journey = pd.DataFrame([[phone, origin, destination, fare, journey_date]], 
                             columns=['phone', 'origin', 'destination', 'fare', 'journey_date'])
